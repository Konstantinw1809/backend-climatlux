...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cooling: Attribute.Decimal;
    heating: Attribute.Decimal;
    coolingBtu: Attribute.BigInteger;
    heatingBtu: Attribute.BigInteger;
    coolingClass: Attribute.String;
    heatingClass: Attribute.String;
    noiseIndoor: Attribute.String;
    noiseOutdoor: Attribute.String;
    scop: Attribute.Decimal;
    seer: Attribute.Decimal;
